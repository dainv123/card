...
function initSlick() {
  ...
  $('.other-menu').on('mouseenter', function() {
    ...
    setTimeout(function() {
      $('.hover-menu')
        .css('-moz-transform', 'translate3d(0, 0px, 0px)')
        .css('-webkit-transform', 'translate3d(0, 84px, 0px)')
        .css('-ms-transform', 'translate3d(0, 84px, 0px)')
        .css('-o-transform', 'translate3d(0, 84px, 0px)')
        .css('transform', 'translate3d(0, 84px, 0px)');
    }, 200);
  });
  ...
  $('.other-menu')
    ...
    .on('mouseleave', function() {
      ...
      setTimeout(function() {
        $('.hover-menu')
          .css('-moz-transform', 'translate3d(0px, -400px, 0px)')
          .css('-webkit-transform', 'translate3d(0px, -400px, 0px)')
          .css('-ms-transform', 'translate3d(0px, -400px, 0px)')
          .css('-o-transform', 'translate3d(0px, -400px, 0px)')
          .css('transform', 'translate3d(0px, -400px, 0px)');
      }, 200);
    });
